...
import email.tianlangstudio.aliyun.com.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = TLAppConfig.getProfile();
    
    /**
     * 是否上传到static
     */
    private static String isstatic= TLAppConfig.getIsstatic();
	...
	public static String getRoot_dir() {
		String url=ClassUtils.getDefaultClassLoader().getResource("").getPath()+ TLAppConfig.getIsroot_dir();
		return url;
	}
            ...
            throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException
    {
    	...
    	// 获得文件后缀名称
    	String suffixName = getFileExtention(fileName);
    ...
    public static final String getFileExtention(String fileName) {
        // 获得文件后缀名称
