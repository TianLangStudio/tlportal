...
import email.tianlangstudio.aliyun.com.model.custom.email.MailSenderInfo;
import email.tianlangstudio.aliyun.com.model.custom.email.MyAuthenticator;
...
public class SimpleEmailUtil {
	...
	public static void sendEmail(TSysEmail tSysEmail) throws Exception {
		...
		mailInfo.setMailServerHost(TLAppConfig.getEmail_smtp());
		mailInfo.setMailServerPort(TLAppConfig.getEmail_port());
		mailInfo.setValidate(true);
		mailInfo.setSsl(true);
		mailInfo.setUserName(TLAppConfig.getEmail_account());
		mailInfo.setPassword(TLAppConfig.getEmail_password());// 您的邮箱密码
